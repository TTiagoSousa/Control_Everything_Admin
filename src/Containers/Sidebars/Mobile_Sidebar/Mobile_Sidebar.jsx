...
import { Navigation_Map } from '../Sidebar_Home/Navigation_Map';
...
const Mobile_Sidebar = () => {
  ...
  const { mobile_Sidebar_Home, show_Mobile_Sidebar_Home } = NavsState();
  ...
  const handleClick = (item) => {
    ...
    show_Mobile_Sidebar_Home(); // Fecha a barra lateral móvel quando um link é clicado
  };
  ...
  return (
    <nav className={`Mobile_Sidebar ${mobile_Sidebar_Home ? 'active' : ''}`}> 
      <header>
        <button onClick={show_Mobile_Sidebar_Home}>Close</button>
      </header>
